...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget textSection = Container( // Define the text section, which is fairly long, as a variable
      padding: const EdgeInsets.all(32.0), // Put the text in a Container to enable adding 32 pixels of padding along each edge
      child: Text(
        '''
